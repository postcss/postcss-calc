...
/** @type {Record<string, MathFunction>} */
const mathFunctions = {
...
const mathFunctionNames = Object.keys(mathFunctions).sort(
...
function isCalculationFunction(name) {
  return mathFunctions[name.toLowerCase()]?.calculation === true;
}
...
function isSupportedMathFunction(name) {
  ...
  return (
    !isCalculationFunction(normalized) &&
    Object.prototype.hasOwnProperty.call(mathFunctions, normalized)
  );
}

  ...
  try {
    ...
    await writeFile(
      ...
      [
        ...
        "if (reduceCalc('calc(1 / 2)', { unwrapSingleNumber: true }) !== '.5') throw new Error('bare fractional option failed');",
      ].join('\n')
    );
    ...
    await writeFile(
      ...
      [
        ...
        'const options: ReduceCalcOptions = { precision: false, unwrapSingleNegativeNumber: true, unwrapSingleNumber: true };',
